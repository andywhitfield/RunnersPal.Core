...
public class CalculatorsController(ILogger<CalculatorsController> logger, IDataCache dataCache) : Controller
{
    private readonly PaceCalculator paceCalc = new();
    private readonly DistanceCalculator distanceCalc = new();
    private readonly WeightCalculator weightCalc = new();
    private readonly CaloriesCalculator caloriesCalc = new();
